...
export function TicketAnimationEmerald() {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < ticketCount; i++) {
      ...
      // Create materials for each face - emerald theme
      const materials = [
        new THREE.MeshStandardMaterial({ color: 0x10b981, metalness: 0.3, roughness: 0.4 }), // right
        new THREE.MeshStandardMaterial({ color: 0x10b981, metalness: 0.3, roughness: 0.4 }), // left
        new THREE.MeshStandardMaterial({ color: 0x059669, metalness: 0.3, roughness: 0.4 }), // top
        new THREE.MeshStandardMaterial({ color: 0x059669, metalness: 0.3, roughness: 0.4 }), // bottom
        new THREE.MeshStandardMaterial({ color: 0x047857, metalness: 0.5, roughness: 0.3 }), // front
        new THREE.MeshStandardMaterial({ color: 0x065f46, metalness: 0.2, roughness: 0.5 }), // back
      ];
