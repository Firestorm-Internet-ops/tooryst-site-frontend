  ...
  <xsl:template match="/">
    <html lang="en">
      <head>
        ...
        <title>XML Sitemap Index - Tooryst</title>
        <style>
          * {
            margin: 0;
            padding: 0;
      ...
      <body>
        <div class="header">
          ...
          <p>This sitemap index contains all sitemaps for Tooryst</p>
        </div>

        <div class="container">
          <div class="description">
            <h2>What is an XML Sitemap?</h2>
            <p>This XML Sitemap Index is generated by Tooryst. It is what search engines like Google use to crawl and re-crawl posts/pages/products/images/archives on your website.</p>
